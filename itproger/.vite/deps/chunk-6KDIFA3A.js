...
var script = {
  ...
  mounted: function mounted() {
    this.rootEl = DomHandler.findSingle(this.$el, '[data-pc-name="'.concat(ObjectUtils.toFlatCase(this.$.type.name), '"]'));
    if (this.rootEl) {
  ...
  methods: {
    ...
    _loadGlobalStyles: function _loadGlobalStyles() {
      ...
      ObjectUtils.isNotEmpty(globalCSS) && BaseStyle.load(globalCSS, _objectSpread({
        name: "global"
      }, this.$styleOptions));
    },
    ...
    _getPT: function _getPT(pt) {
      ...
      var getValue = function getValue2(value) {
        ...
        var _cKey = ObjectUtils.toFlatCase(_this3.$name);
  ...
  computed: {
    ...
    defaultPT: function defaultPT() {
      ...
      return this._getPT((_this$$primevueConfig5 = this.$primevueConfig) === null || _this$$primevueConfig5 === void 0 ? void 0 : _this$$primevueConfig5.pt, void 0, function(value) {
        return _this5._getOptionValue(value, _this5.$name, _objectSpread({}, _this5.$params)) || ObjectUtils.getItemValue(value, _objectSpread({}, _this5.$params));
      });
    },
...
//# sourceMappingURL=chunk-6KDIFA3A.js.map
